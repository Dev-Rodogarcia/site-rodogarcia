          ...
          {activeSlides.map((slide, index) => {
            ...
            return (
              ...
              >
                ...
                {!isImageOnly ? (
                  <div className="home-hero-content relative z-10 mx-auto grid min-h-[clamp(704px,96vh,1012px)] max-w-[1320px] grid-cols-1 items-center gap-10 px-6 pb-26 pt-35 sm:px-8 sm:pb-28 sm:pt-28 md:max-lg:justify-items-center lg:grid-cols-[minmax(0,504px)_minmax(0,1fr)] lg:gap-14 lg:px-10 lg:pt-32 xl:px-12">
