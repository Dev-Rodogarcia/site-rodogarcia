...
const editableCardClassName =
  "relative overflow-hidden rounded-[24px] border border-[var(--primary)]/20 bg-slate-50/86 p-4 shadow-[0_12px_28px_rgba(15,23,42,0.045)] before:absolute before:inset-x-0 before:top-0 before:h-1 before:bg-[var(--primary)] sm:p-5";
  ...
  return (
    <DeveloperPage>
      ...
      <div className="mt-5 grid gap-5">
        <DeveloperCard id="services-modules" className="p-5 sm:p-6">
          ...
          >
            <article key={activeModule.id} className={editableCardClassName}>
                <div className="mb-5 flex items-start gap-3 border-b border-slate-200/70 pb-4">
                ...
                <div className={formGroupClassName}>
                  ...
                  <div className="mt-4 grid gap-4 md:grid-cols-2">
                    ...
                    <DeveloperField label="Classe de enquadramento" hint="Uso técnico para preservar o corte visual atual.">
                      <input
                ...
                <div className={cn(formGroupClassName, "mt-4 grid gap-5 lg:grid-cols-2")}>
                ...
                <div className={cn(formGroupClassName, "mt-4")}>
                  <DeveloperSectionHeading
                    title="Tópicos fixos"
                ...
                <div className={cn(formGroupClassName, "mt-4 grid gap-5 md:grid-cols-2")}>
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      isActive
                        ? "border-[var(--primary)]/35 bg-white shadow-[0_14px_34px_rgba(15,23,42,0.08)] before:absolute before:inset-x-4 before:top-0 before:h-1 before:rounded-b-full before:bg-[var(--primary)]"
        ...
        <DeveloperCard id="services-final-cta" className="p-5 sm:p-6">
          <DeveloperSectionHeading
            eyebrow="CTA final"
          ...
          />
          <form
            className={cn(formGroupClassName, "grid gap-5 md:grid-cols-2")}
            onSubmit={(event) => {
              event.preventDefault();
