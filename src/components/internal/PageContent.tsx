...
export function PageHero({
  ...
  if (isCenteredDarkHero) {
    return (
      <section
        className={cn(
          "relative overflow-hidden bg-[var(--foreground)] pt-20 sm:pt-24 lg:pt-28",
          className
        )}
      >
    ...
    >
      ...
      <div
        className={cn(
          ...
          isDark
            ? "bg-[radial-gradient(circle_at_top_left,rgba(29,78,216,0.1),transparent_40%),radial-gradient(circle_at_78%_14%,rgba(56,189,248,0.06),transparent_24%)]"
            : "bg-[radial-gradient(circle_at_14%_14%,rgba(29,78,216,0.12),transparent_24%),radial-gradient(circle_at_84%_12%,rgba(6,182,212,0.14),transparent_22%)]"
        )}
      />
      {isDark ? (
        <>
          ...
          >
            ...
            >
              ...
              {(primaryAction || secondaryAction) && (
                ...
                >
                  {primaryAction ? (
                    <ActionLink action={primaryAction} tone={isDark ? "dark" : "light"} />
                  ) : null}
                  {secondaryAction ? (
                    <ActionLink action={secondaryAction} tone={isDark ? "dark" : "light"} />
                  ) : null}
                </div>
              )}
    ...
    <section className="py-20 sm:py-32">
      <PageContainer>
        <div className="mx-auto flex max-w-xl flex-col items-center text-center">
          <span className="mb-5 inline-flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.28em] text-[var(--primary)]">
            <span className="h-1.5 w-1.5 rounded-full bg-[var(--primary)]" />
            {eyebrow}
          </span>

          <h2 className="text-[clamp(2rem,3.6vw,3.2rem)] font-extrabold leading-[1.08] tracking-[-0.04em] text-[var(--foreground)]">
            {title}
          </h2>

          <div className="mx-auto mt-6 h-px w-12 bg-gradient-to-r from-transparent via-[var(--primary)]/40 to-transparent" />

          <p className="mt-5 max-w-[38ch] text-[15px] leading-7 text-slate-500">
            {description}
          </p>
          ...
          <div className="mt-10 flex w-full flex-col items-center justify-center gap-4 sm:flex-row sm:gap-5">
            <Link
              ...
              {...(primaryAction.external
                ...
                : {})}
              className="group inline-flex min-h-[64px] w-full items-center justify-center rounded-full bg-[var(--primary)] px-10 text-[15px] font-extrabold tracking-tight text-white shadow-[0_12px_32px_rgba(2,132,199,0.25)] transition-all duration-200 hover:-translate-y-1 hover:bg-[var(--primary)]/90 hover:shadow-[0_20px_48px_rgba(2,132,199,0.35)] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[var(--primary)]/30 sm:w-auto sm:min-w-[320px]"
            >
            ...
            {secondaryAction ? (
              <Link
                ...
                {...(secondaryAction.external
                  ? { target: "_blank", rel: "noopener noreferrer" }
                  : {})}
                className="inline-flex min-h-[64px] w-full items-center justify-center rounded-full bg-slate-900 px-10 text-[15px] font-bold tracking-tight text-white shadow-[0_12px_32px_rgba(15,23,42,0.15)] transition-all duration-200 hover:-translate-y-1 hover:bg-slate-800 hover:shadow-[0_20px_48px_rgba(15,23,42,0.25)] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-slate-900/30 sm:w-auto sm:min-w-[240px]"
              >
...
export function ActionLink({
  ...
  const sharedClassName =
    "inline-flex min-h-14 items-center justify-center gap-2 rounded-2xl px-6 py-3 text-sm font-semibold transition-all duration-200 hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-4";
