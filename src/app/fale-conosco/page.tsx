...
export default function FaleConoscoPage() {
  const contact = getContactSiteTexts(readSiteTextsData());
  ...
  return (
    <PageShell>
      ...
      >
        <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(180deg,#111827_0%,#182233_100%)]" />
        <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(180deg,rgba(255,255,255,0.025)_0%,transparent_42%)]" />
        <div className="pointer-events-none absolute inset-0 opacity-[0.035] [background-image:linear-gradient(rgba(255,255,255,0.42)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.42)_1px,transparent_1px)] [background-size:40px_40px]" />
      ...
      <PageCtaBand
        ...
        title="Se o objetivo ja estiver claro, voce pode seguir direto."
        description="O CTA final tambem sai do CMS, para a equipe comercial ajustar o destino quando precisar."
        primaryAction={{
          label: contact.ctaLabel,
          href: contact.ctaUrl,
        }}
        ...
        benefits={["Dados oficiais", "Canal comercial", "Fluxo sem ruido"]}
      />
    </PageShell>
  );
}
