      ...
      <section className="relative overflow-hidden bg-[linear-gradient(180deg,#07111f_0%,#050b16_100%)] py-16 sm:py-20 lg:py-24">
        ...
        <div className="relative mx-auto max-w-[960px] px-5 text-center sm:px-8">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:justify-center">
            <Link
              href={site.quote}
              className="inline-flex min-h-14 items-center justify-center gap-2 rounded-full bg-white px-7 py-3 text-sm font-semibold text-slate-950 shadow-[0_22px_54px_rgba(2,6,23,0.28)] transition-all duration-200 hover:-translate-y-0.5 hover:bg-slate-100"
            >
              Solicitar cotação
              <ArrowUpRight size={16} weight="bold" />
            </Link>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex min-h-14 items-center justify-center gap-2 rounded-full border border-white/12 bg-white/8 px-7 py-3 text-sm font-semibold text-white transition-all duration-200 hover:-translate-y-0.5 hover:bg-white/12"
            >
              Rastreio oficial
              <ArrowUpRight size={16} weight="bold" />
            </a>
