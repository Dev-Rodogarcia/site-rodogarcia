...
| Hostname do tunnel do site | `site.rodogarcia.com.br` -> `http://127.0.0.1:6060` |
| Hostname do tunnel da API | `sitebackend.rodogarcia.com.br` -> `http://127.0.0.1:6050` |
...
4. Configure o Cloudflare Tunnel com os dois encaminhamentos indicados na tabela. Não crie hostname ou ingresso para a API CMS (`6051`) nem para o painel CMS (`6061`): o site em `6060` encaminha internamente `/admin/*` e as rotas CMS correspondentes.
